...
public class Step04MethodTest extends PlainTestCase {
    ...
    String replaceAtoB(String str) { return str.replace("A", "B"); }

    String replaceCtoB(String str) { return str.replace("C", "B"); }

    String addPrefix(String pre, String fix) { return pre + ":" + fix; }

    private boolean availableLogging = true;

    boolean isAvailableLogging() {
        return availableLogging;
    }

    void showSea(String str) { log(str); }
}
