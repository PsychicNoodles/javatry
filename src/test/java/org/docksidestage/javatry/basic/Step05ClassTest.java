...
public class Step05ClassTest extends PlainTestCase {
    ...
    public void test_class_howToUse_wrongQuantity() {
        ...
        log(sea); // your answer? => 9 (fixed to 10)
    }
...
//        log(oneDayPassport.isAlreadyIn()); // should be true
    ...
    public void test_class_moreFix_return_whole() {
        ...
        TicketBuyResult twoDayPassportResult = booth.buyMultiDayPassport(handedMoney);
...
//        Ticket twoDayPassport = twoDayPassportResult.getTicket();
//        Ticket oneDayPassport = booth.buyOneDayPassport(10000);
//        log("first ticket type: " + checkTicketType(twoDayPassport));
//        log("second ticket type: " + checkTicketType(oneDayPassport));
    }

//    private String checkTicketType(Ticket ticket) {
//        if (ticket.getDisplayPrice() == TicketBooth.getOneDayPrice()) {
//            return "one day";
//        } else if (ticket.getDisplayPrice() == TicketBooth.getTwoDayPrice()) {
//            return "two day";
//        }
//        return null;
//    }
    ...
    public void test_class_moreFix_useInterface() {
        // your confirmation code here
        TicketBooth booth = new TicketBooth();
        TicketBuyResult oneDayResult = booth.buyOneDayPassport(10000);
        OneDayTicket oneDay = ((OneDayTicket) oneDayResult.getTicket());
        oneDay.doInPark();
        log("one day passport finished: " + oneDay.isAlreadyIn());
        TicketBuyResult multiDayResult = booth.buyMultiDayPassport(30000);
        MultiDayTicket multiDay = ((MultiDayTicket) multiDayResult.getTicket());
        for (int i = 0; i < 4; i++) {
            multiDay.doInPark();
        }
        log("multi day passport finished: " + (multiDay.getCurrentDays() == multiDay.getDayLimit()));
    }
    ...
    public void test_class_moreFix_wonder() {
        // your confirmation code here
        TicketBooth booth = new TicketBooth();
        TicketBuyResult result = booth.buyMultiDayPassport(22500);
        log("day limit: " + result.getTicket().getDayLimit());
    }
