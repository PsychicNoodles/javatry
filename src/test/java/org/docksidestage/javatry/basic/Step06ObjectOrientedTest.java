...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    private void doShowYourTicket(Ticket ticket) {
        log("Your Ticket: displayPrice={}, isAtLimit={}", ticket.getDisplayPrice(), ticket.isAtLimit());
    }
    ...
    public void test_objectOriented_polymorphism_makeConcrete() {
        // your confirmation code here
        Animal hedgie = new Hedgehog();
        BarkedSound sound = hedgie.bark();
        String sea = sound.getBarkWord();
        log(sea);
    }
    ...
    public void test_objectOriented_writing_generalization_extractToAbstract() {
        ...
        St6Sql postgres = new St6PostgreSql();
        log(mysql.buildPagingQuery(10, 1));
        log(postgres.buildPagingQuery(10, 1));
    }
    ...
    public void test_objectOriented_writing_specialization_extractToConcrete() {
        // your confirmation code here
        St6OperationSystem mac = new St6Mac("macaroni");
        St6OperationSystem win = new St6Windows("balcony");
        St6OperationSystem oldWin = new St6OldWindows("veranda");
        log(mac.buildUserResourcePath("home"));
        log(win.buildUserResourcePath("home"));
        log(oldWin.buildUserResourcePath("home"));
    }
    ...
    public void test_objectOriented_writing_withDelegation() {
        // your confirmation code here
        Animal dog = new Dog();
        dog.bark(); // should have log messages coming from BarkingProcess
    }
